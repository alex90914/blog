                    ...
                    <div class="feed-about">
                       ...
                       <!-- <ul class="widget-icon">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="fa fa-info-circle fa-fw"></i>博主：<small>晓飞</small></li>
                            <li><i class="fa fa-user-circle fa-fw"></i>职业：<small>码农</small></li>
                            <li><i class="fa fa-home fa-fw"></i>籍贯：<small>四川</small></li>
                            <li><i class="fa fa-envelope-square fa-fw"></i>邮箱：<small>343618924@qq.com</small></li>
                            <li><i class="fa fa-book fa-fw"></i>简介：<small>java后端工程师,大数据和Linux服务器爱好者</small></li>
                        </ul>
                    </div>
                </div>
            </div>
